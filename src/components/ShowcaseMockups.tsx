        ...
        <div className="flex-1 flex flex-col gap-6 items-center relative">
          <div className="flex flex-row gap-2 justify-center items-end md:gap-4">
            ...
            <img
              ...
              className="w-32 sm:w-40 md:w-56 shadow-lg rounded-2xl border bg-transparent"
              style={{ zIndex: 3 }}
            />
            {/* Celular inclinado */}
            <img
              ...
              className="w-24 sm:w-32 md:w-40 shadow-lg rounded-2xl border bg-transparent -ml-2 md:-ml-8"
              style={{ zIndex: 2 }}
            />
            ...
            <img
              ...
              className="w-20 sm:w-28 md:w-44 shadow-md rounded-2xl border bg-transparent -ml-3 md:-ml-10 mb-0 md:mb-10"
              style={{ zIndex: 1 }}
            />
          </div>
        </div>
